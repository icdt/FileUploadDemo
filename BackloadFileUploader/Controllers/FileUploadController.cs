...
using BackloadFileUploader.Models;
using System;
...
namespace BackloadFileUploader.Controllers
{
    ...
    public class FileUploadController : BackloadController
    {
        ...
        public FileUploadController(ApplicationDbContext p_db)
        {
            db = p_db;
        }

        [ChildActionOnly]
        public PartialViewResult _FileUploader(string UserId, string AlbumId)
        {
            //ViewBag.UserId = dict["UserId"];
            //ViewBag.AlbumId = dict["AlbumId"];
        ...
        public async Task<ActionResult> FileHandler()
        {
            ...
            handler.DeleteFilesRequestFinished += handler_DeleteFilesRequestFinished;
        ...
        public void handler_IncomingRequestStarted(object sender, IncomingRequestEventArgs e)
        {
        ...
        void handler_AuthorizeRequestStarted(object sender, AuthorizeRequestEventArgs e)
        {
        ...
        void handler_AuthorizeRequestFinished(object sender, AuthorizeRequestEventArgs e)
        {
        ...
        void handler_GetFilesRequestStarted(object sender, GetFilesRequestEventArgs e)
        {
        ...
        void handler_GetFilesRequestFinished(object sender, GetFilesRequestEventArgs e)
        {
        ...
        void handler_GetFilesRequestException(object sender, GetFilesRequestEventArgs e)
        {
        ...
        void handler_StoreFileRequestStarted(object sender, Backload.Eventing.Args.StoreFileRequestEventArgs e)
        {
                ...
                newPhoto.Title = e.Param.FileStatusItem.FileName;
                newPhoto.IsPublish = true;
        ...
        void handler_DeleteFilesRequestFinished(object sender, DeleteFilesRequestEventArgs e)
        {
            ...
            Task.Factory.StartNew(
               () =>
               {
                   ...
                   {
                       if (System.IO.File.Exists(file.StorageInfo.FilePath)) System.IO.File.Delete(file.StorageInfo.FilePath);
                   }
               });
        ...
        void handler_DeleteFilesRequestException(object sender, DeleteFilesRequestEventArgs e)
        {
